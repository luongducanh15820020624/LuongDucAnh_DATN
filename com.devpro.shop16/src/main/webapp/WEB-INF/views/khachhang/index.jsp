...
<main class="container">
    ...
    <div class="content">
        ...
        <div class="about">
            ...
            <div class="about-us">
                ...
                <p>Instagram: _ducanh1508_</p>

                <p>Facebook: MSIC.VN</p>

                <p>Shopee: momsaysimcool.vn</p>

                <p>Số điện thoại liên lạc: 0969754938 hoặc 0976578416</p>

                <p>Địa chỉ: 41 Cốc Lương-Tân Hưng-Sóc Sơn-Hà Nội.</p>
            </div>
        </div>
        <!--close about us-->
    ...
    <div class="copyright">
        Copyright <i class="far fa-copyright"></i> <a href="#">msic.</a> <a
            href="#">© ĐỒ ÁN THIẾT KẾ by LƯƠNG ĐỨC ANH KHMT02-K15.</a>
    </div>
</main>
