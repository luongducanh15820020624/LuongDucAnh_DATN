...
<div class="footer">
	...
	<div class="introduc">
		...
		<div class="introduc-contact">
			...
			<div class="introduc-list">
				<ul>
					<li><i class="fas fa-map-marker-alt"></i> 41 Cốc Lương-Tân Hưng-Sóc Sơn-Hà Nội.</li>
					<li><i class="fas fa-phone-volume"></i> 0969754938</li>
					<li><i class="fas fa-phone-volume"></i> 0976578416</li>
